...
print('Residuals from stated PDE:',np.round(R,6)); print(f'Mean squared residual: {loss:.6f}'); print('These values are consistent with the corrected Chapter 6, Case 5 manuscript.')
